...
# import numpy as np
# 
# df = pd.read_csv("Z:/Documents/SCANN_Lab/MetaAnalysis/hippo_vol_meta/Part2_Web_of_science_search_results.csv")
# 
...
# # %%
# 
# a = df[df['Meets Criteria?'] == 'Y'].copy()
# 
# a['first_author'] = df['first_author']
# 
# a['All_authors']=a['first_author']
# 
# 
# 
# test = a['All_authors'].append(a['last_author'], ignore_index=True, sort=False)
# =============================================================================
...
filename = os.path.join(dirname, 'Part2_Web_of_science_search_results.csv')
